...
{                        
    ...
    if (user == null)
    {
        return RedirectToAction("LogOn",new { message="Unable to log in with " + loginInfo.Login.LoginProvider + 
...
private IAuthenticationManager AuthenticationManager
{
    get
    {
        ...
        public ActionResult EmailPassword(string email)
        {
            ...
            if (user == null)
                ErrorDisplay.ShowError("Email address doesn't exist. Please make sure you have typed the address correctly");
            else
            {
