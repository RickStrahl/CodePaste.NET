		...
		protected override string Keywords 
		{
			...
			{ 
				return "AddHandler AddressOf AndAlso Alias And Ansi As Assembly "
					...
					+ "Operator Option Optional Or Order OrElse Overloads Overridable Overrides ParamArray "
